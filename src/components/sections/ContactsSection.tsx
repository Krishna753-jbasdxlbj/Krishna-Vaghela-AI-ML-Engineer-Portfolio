    ...
    <div className='h-dvh relative' ref={contactsSectionRef}>
      ...
      {circles.map(({ ref, side }, i) => (
        <div
          key={i}
          ref={ref}
          className={`w-40 h-40 rounded-full absolute top-1/3 ${side} z-1 -translate-y-1/2`}
      ...
      >
        <div
          ref={textRef}
          className='flex whitespace-nowrap font-holtwood min-[320px]:text-4xl sm:text-5xl md:text-6xl text-accent'
        >
      ...
      <div className='h-screen w-full flex flex-col justify-center items-center min-[320px]:gap-10 sm:gap-20 z-2 absolute'>
        <div
          ...
          className='relative text-accent cursor-pointer text-center uppercase font-holtwood min-[320px]:text-xl text-2xl leading-none min-[320px]:-mt-[15vh] sm:-mt-10'
        >
          <div ref={downloadRef}>
            download <br /> <br />
