...
export const particleConfigs = [
  { variant: 'node', size: 120, position: 'top-0 left-10 z-2' },
  { variant: 'dot', size: 60, position: 'top-10 left-2/3 z-2' },
  { variant: 'hex', size: 90, position: 'top-0 -right-5 z-2' },
];
